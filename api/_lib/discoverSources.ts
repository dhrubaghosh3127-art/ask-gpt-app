...
export const DISCOVER_SOURCES: DiscoverSource[] = [
  ...
  },
  {
    ...
    tab: 'bangladesh',
    label: 'DW বাংলা',
    feedUrl: 'https://rss.dw.com/rdf/rss-beng-all',
    language: 'bn',
    region: 'bangladesh',
    category: 'বিশ্ব',
    priority: 89,
  ...
  {
    id: 'bd_entertainment_ajkerpatrika',
    tab: 'bangladesh',
    label: 'আজকের পত্রিকা',
  ...
  {
    id: 'bd_lifestyle_bangladeshjournal',
    tab: 'bangladesh',
  ...
  },
  {
    ...
    tab: 'bangladesh',
    label: 'আরটিভি',
    feedUrl: 'https://www.rtvonline.com/rss.xml',
    language: 'bn',
    region: 'bangladesh',
    category: 'প্রযুক্তি',
    priority: 76,
  ...
  },
  {
    ...
    tab: 'bangladesh',
    label: 'এনটিভি',
    feedUrl: 'https://www.ntvbd.com/rss.xml',
    language: 'bn',
    region: 'bangladesh',
    category: 'খেলা',
    priority: 75,
  ...
  {
    id: 'bd_education_ekattor',
    tab: 'bangladesh',
    label: 'একাত্তর',
    feedUrl: 'https://ekattor.tv/feed',
    language: 'bn',
    region: 'bangladesh',
    category: 'শিক্ষা',
    priority: 72,
