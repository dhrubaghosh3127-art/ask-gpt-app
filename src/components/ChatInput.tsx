...
const textareaClassName = "flex-1 bg-transparent border-none focus:ring-0 text-[24px] leading-tight text-gray-900 dark:text-white placeholder:text-gray-400 px-2 py-2 resize-none max-h-[120px]";
