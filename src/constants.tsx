...
export const MODELS = [
  { id: "gemini-1.5-flash", name: "ASKGPT 2.5 Flash (Default)", description: "Normal chat + light tasks" },
  { id: "gemini-2.5-flash", name: "ASKGPT 2.5 Flash (Hard)", description: "Hard math / code" },
