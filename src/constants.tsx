...
export const MODELS = [
  { id: "gemini-1.5-flash", name: "ASKGPT 1.5 Flash (Default)", description: "Normal chat + light tasks" },
  { id: "gemini-2.5-flash", name: "ASKGPT 1.5 pro (Hard)", description: "Hard math / code" },
